...
def calculate_percentage(self):
   # .student.set gives a reverse relation basically all the students in standard
    total_students = self.classroom.standard.student_set.count()
    if total_students == 0:
        return 0
