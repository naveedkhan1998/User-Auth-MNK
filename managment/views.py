...
from .serializers import StandardSerializer,SubjectSerializer,SubjectSerializerPOST,StudentSerializer,StudentSerializerPOST,ClassRoomSerializer,ClassRoomSerializerPOST,ClassRoomAttendanceSerializer,ClassRoomAttendanceSerializerPOST
...
class StandardView(APIView):
    ...
    def get(self,request,format=None):
        ...
        return Response({'data':serializer.data,'msg':'sent_successfully'},status=status.HTTP_200_OK)
    ...
    def post(self,request,format=None):
        ...
        if serializer.is_valid(raise_exception=True):
            obj = serializer.save()
            return Response({"new_object":{'id':obj.id,**serializer.data},"msg":"created_succesfully"},status=status.HTTP_201_CREATED)
    ...
    def delete(self,request,format=None):
        ...
        if qs.exists():
            ...
            return Response({"errors":{'integrity':'object with the given id doesnt exist'},"msg":"Id not Found"},status=status.HTTP_404_NOT_FOUND)
...
class StudentView(APIView):
    ...
    def post(self,request,format=None):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            return Response({"new_object":new_data,"msg":"created_succesfully"},status=status.HTTP_201_CREATED)
...
class ClassRoomAttendanceView(APIView):
    ...
    def post(self,request,format=None):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            new_obj.attendance_percentage = (new_obj.students_present.count()/(new_obj.students_abscent.count()+new_obj.students_present.count()))*100
            new_obj.save()
    ...
    def put(self,request,format=None):
        ...
        if qs.exists():
            ...
            return Response({"msg":"updated_succesfully"},status=status.HTTP_201_CREATED)
        return Response({'errors':{'integrity':'object with the given id doesnt exist'},"msg":"Not Found"},status=status.HTTP_404_NOT_FOUND)
