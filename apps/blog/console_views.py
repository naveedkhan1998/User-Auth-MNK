...
class BlogPostCreateView(StaffOnlyMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f"Blog post '{form.instance.title}' created successfully!")
        return response
...
class BlogPostUpdateView(StaffOnlyMixin, UpdateView):
    ...
    def form_valid(self, form):
        response = super().form_valid(form)
        messages.success(self.request, f"Blog post '{form.instance.title}' updated successfully!")
        return response
...
class BlogPostDeleteView(StaffOnlyMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        messages.success(request, f"Blog post '{blog_post.title}' deleted successfully!")
