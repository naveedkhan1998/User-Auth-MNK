...
def run_console_commands(commands):
    ...
    if console_creation_response.status_code == 201:
        ...
        print(f'Failed to create console. Status code: {console_creation_response.status_code}')
...
# Restart the web app
webapp_domain_name = 'naveedkhan98.pythonanywhere.com'  # Replace with your web app's domain name
